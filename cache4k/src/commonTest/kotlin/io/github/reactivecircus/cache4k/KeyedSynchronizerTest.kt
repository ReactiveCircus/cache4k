...
class KeyedSynchronizerTest {
    ...
    @Test
    fun actionsAssociatedWithTheSameKeyAreMutuallyExclusive() = runTest {
        val key = "a"
        var action1Started = false
        var action2Started = false
        var action3Started = false

        val actionTime = 3000L
    ...
    @Test
    fun actionsAssociatedWithDifferentKeys_run_concurrently() = runTest {
        var action1Started = false
        var action2Started = false
        var action3Started = false
    ...
    @Test
    fun newActionUsingSameKeyFromDifferentThread_is_queuedAfterExistingBlockedActions() = runTest {
        val key = "a"
        var action1Started = false
        var action2Started = false
        var action3Started = false
    ...
    @Test
    fun whenActionUsingSameKeyFromAnotherThreadThrowsErrorTheNextAction_is_unblocked() = runTest {
        val key = "a"
        var action1Started = false
        var action2Started = false
        var action3Started = false
